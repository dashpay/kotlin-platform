...
%ignore platform_mobile_config_RustSdk_destroy(RustSdk *ffi);
%ignore platform_mobile_config_RustSdk5_ctor(void *entry_point);
%ignore platform_mobile_config_RustSdk5_destroy(RustSdk5 *ffi);
