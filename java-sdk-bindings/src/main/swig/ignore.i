...
%ignore rs_sdk_platform_types_identity_PublicKeyHash_ctor(uint8_t);
%ignore rs_sdk_platform_types_identity_PublicKeyHash_destroy(rs_sdk_platform_types_identity_PublicKeyHash *ffi);
