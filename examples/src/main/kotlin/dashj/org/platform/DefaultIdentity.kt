    ...
    init {
        when {
            params.id.contains("test") -> {
                // seed = "domain major supply stove finger endorse crystal grape cinnamon syrup happy total"
                seed = "good step tragic correct coral garbage provide this owner merry ride mammal"
            }
